...
namespace TourBuddy.Services.Facebook
{
    public class FacebookAuthService
    {
        private readonly string _appId = "678861304538758";
        // WARNING: App secret should ideally be stored on a server, not in client code
        private readonly string _appSecret = "389c49df07a0ca5359eefb3466382dab";
        private readonly string _redirectUri = "https://k1ngjj.github.io/faceback/faceback.html";
        private readonly string _appScheme = "com.itdc.tourbuddy";
